---
title: See/Hear/Feel and the Sensory Grid
atlas_type: concept
tier: practice
status: draft
---
...
First make the range explicit. A label means different things in Focus In,
Focus Out, Rest, Flow, Space, or Everything. Then choose the simplest label
that preserves contact and CCE.
...
The practical test is not whether the label is maximally exact. The test is
whether the label helps attention know the event, stay with it briefly, and
allow it to change.
