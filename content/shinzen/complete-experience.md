...
1. **Contact**: the event is actually noticed, not merely thought about.
2. **Clarity**: the event becomes distinguishable in sensory terms.
3. **Equanimity**: the event is allowed to arise, change, and pass without extra struggle.
4. **Time**: the nervous system gets enough repetitions or duration to learn.
...
| --------------------------------------------- | ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| too intense or body-unsafe                    | stop pushing, change posture, rest, or get ordinary support                        | [Intensity and Embodiment Safety](intensity-and-embodiment-safety.md)               |
| vague, blank, or dissociated                  | simplify the range, use clearer labels, or choose an easier object                 | [Practice Method Safety](practice-method-safety.md)                                 |
| sticky with craving, fear, or aversion        | include the reaction itself if it is workable                                      | [Recycle the Reaction](recycle-the-reaction.md)                                     |
| pleasant but grasped                          | notice the grasping as part of the object, not as a moral flaw                     | [Condition-Independent Happiness](condition-independent-happiness.md)               |
| spiritually convincing but behavior-worsening | test repair, feedback, commitments, and service before trusting the interpretation | [Behavior and Service Test](behavior-and-service-test.md)                           |
| impossible to drop as a practice frame        | switch, stop, rest, or bring in guidance rather than proving toughness             | [Completion Versus Bypass and Intensity](completion-versus-bypass-and-intensity.md) |
...
- [Signs and Non-Signs of Completion](signs-and-non-signs-of-completion.md)
