...
Total Happiness names Shinzen's broad aim: surface and deep happiness for self and others. The compact version is the four-quadrant map below; the fuller public map is [Total Happiness Aim Structure](total-happiness-aim-structure.md).
...
| | Self | Others |
| --- | --- | --- |
| Surface happiness | improve ordinary conditions, health, relationships, livelihood | reduce suffering and support conditions where possible |
| Deep happiness | train fulfillment less dependent on conditions | help others access deep well-being when appropriate |
