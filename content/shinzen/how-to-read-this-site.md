...
Read [The Path](index.md#the-path) in order when you want the whole architecture. Jump by problem from the home page when something is already live. Use [Full Map](map.md) or [Glossary](glossary.md) when you are looking for a specific term, technique, boundary, or phenomenon.
...
- [The Shinzen Practice Atlas](index.md)
- [Full Map](map.md)
- [Glossary](glossary.md)
- [Source and Claim Tiers](source-and-claim-tiers.md)
- [Going Deep Safely](going-deep-safely.md)
